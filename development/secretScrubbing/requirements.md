...
- FR-1.2: Detect common secret key names (PASSWORD, TOKEN, SECRET, API_KEY, etc.)
...
- FR-5.7: Handle malformed .gitignore file
...
- FR-6.2: Append missing patterns to .gitignore
...
# .gitignore now contains all required patterns
```
...
- FR-7.3: Cache scrubbing results for identical strings
- FR-7.4: Skip scrubbing for non-sensitive operations
...
**Description:** Allow certain patterns to bypass scrubbing

**Requirements:**
- FR-8.1: Whitelist common non-secret patterns (DEBUG, NODE_ENV, etc.)
...
- NFR-1.4: No noticeable lag in error display
...
- NFR-3.3: Easy to add new patterns
- NFR-3.4: Comprehensive unit tests
- NFR-3.5: Clear documentation

**Verification:**
- Code review confirms single source of truth
- Adding new pattern requires < 5 lines of code
...
- NFR-4.3: No way to disable scrubbing
...
- Test-1.4: scrubSecrets() with multi-line secrets
...
- Test-4.4: Handles malformed .gitignore
